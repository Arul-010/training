...
import { FiArrowLeft, FiEdit2, FiTrash2, FiMail, FiPhone, FiDollarSign, FiCalendar, FiBriefcase, FiGift } from 'react-icons/fi';
        ...
        <div className="card details-profile-card fade-in">
          ...
          <div className="details-info-grid">
            ...
            <div className="details-section-column">
              <h3 className="details-section-title">Personal & Contact Information</h3>
              ...
              <div className="details-info-row">
                <FiGift className="info-row-icon" />
                <div className="info-row-text">
                  <span className="info-label">Date of Birth (D.O.B)</span>
